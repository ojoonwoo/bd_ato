			<div id="popup_level3_clear" class="c-popup">
				<div class="c-popup__aligner">
					...
					<div class="c-popup__box">
						...
						<div class="c-section c-section--small">
							<div class="c-popup__forms">
								...
								<div class="c-popup__form">
									...
									<div class="c-popup__value">
										<input type="text" id="level3_phone" class="c-popup__input" onkeyup="wmbt.only_num(this);wmbt.chk_strlen(this);" />
									</div>
								</div>
								<div class="c-popup__form c-popup__form--button">
									...
									<div class="c-popup__value">
										...
										<a href="#" class="c-search__button" onclick="wmbt.findAddr(3)">찾기버튼</a>
									</div>
								</div>
								<div class="c-popup__form c-popup__form--button">
									<div class="c-popup__value">
						...
						<div class="c-section">
							<div class="c-popup__buttons" onclick="wmbt.levelSubmit(this, 3);">

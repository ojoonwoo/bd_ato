		...
		<div class="c-content c-content--sub">
			<div class="wrapper video">
				<div class="title tt-deco">
					<img src="./images/event_2/popup_title_video2.png" alt="메이크업 인지 테스트">
				</div>
				<div class="area-video">
					<div class="wrapper">
						<iframe allowfullscreen="1" src="https://www.youtube.com/embed/p3i30xDx6tA?controls=0&loop=1&playlist=p3i30xDx6tA&modestbranding=1&showinfo=0&wmode=opaque&enablejsapi=1&rel=0&autoplay=1" frameborder="0" id="ytplayer" class="ytplayer" style="position:relative;z-index:11;left:9px;top:7px"></iframe>
						<div class="video">
